...
// addEventListener("keydown",function(e){keysDown[e.keyCode]=false;},false);
...
//     ghost1Image.src="Images/ghosts/ghost1.png";
//     ghost2Image=new Image();
//     ghost2Image.src="Images/ghosts/ghost2.png";
//     ghost3Image=new Image();
//     ghost3Image.src="Images/ghosts/ghost3.png";
//     ghost4Image=new Image();
//     ghost4Image.src="Images/ghosts/ghost4.png";
...
//     setInterval(move_monster1,2500)
...
//     ghost1_x=rand_x;
//     ghost1_y=rand_y;
//     board[ghost1_x][ghost1_y]=5;
//     ctx.drawImage(ghost1Image,ghost1_x*30,ghost1_y*30,30,30);
// }

// function move_monster1(){
//     ctx.clearRect(ghost1_x*30,ghost1_y*30,30,30);
//     if (pacman_x!=ghost1_x && pacman_y!=ghost1_y ){
//     let moves=[-1,0,1]
//     let rand_x = Math.floor(Math.random() * 3);
//     let rand_y = Math.floor(Math.random() * 3);
//     while (!is_valid_move(ghost1_x+rand_x,ghost1_y+rand_y)){
//         rand_x = Math.floor(Math.random() * 20);
//         rand_y = Math.floor(Math.random() * 20);
//     }
//     ghost1_x=ghost1_x+moves[rand_x];
//     ghost1_y=ghost1_y+moves[rand_y];
// }
//     else if(pacman_x==ghost1_x){
//         if (ghost1_y>pacman_y){
//             if(is_valid_move(ghost1_x,ghost1_y-1)){
//                 ghost1_y--
//             }
//             else{
//                 while (!is_valid_move(ghost1_x+rand_x,ghost1_y+rand_y)){
...
//             if(is_valid_move(ghost1_x-1,ghost1_y)){
//             ghost1_x--
//             }
//             else{
//                 while (!is_valid_move(ghost1_x+rand_x,ghost1_y+rand_y)){
...
//     ghost2_x=rand_x;
//     ghost2_y=rand_y;
//     board[ghost2_x][ghost2_y]=5;
//     ctx.drawImage(ghost2Image,ghost2_x*30,ghost2_y*30,30,30);
// }

// function move_monster2(){
//     ctx.clearRect(ghost2_x*30,ghost2_y*30,30,30);
//     if (pacman_x!=ghost2_x && pacman_y!=ghost2_y ){
//     let moves=[-1,0,1]
//     let rand_x = Math.floor(Math.random() * 3);
//     let rand_y = Math.floor(Math.random() * 3);
//     while (!is_valid_move(ghost2_x+rand_x,ghost2_y+rand_y)){
//         rand_x = Math.floor(Math.random() * 20);
//         rand_y = Math.floor(Math.random() * 20);
//     }
//     ghost2_x=ghost2_x+moves[rand_x];
//     ghost2_y=ghost2_y+moves[rand_y];
// }
//     else if(pacman_x==ghost2_x){
//         if (ghost2_y>pacman_y){
//             if(is_valid_move(ghost2_x,ghost2_y-1)){
//                 ghost2_y--
//             }
//             else{
//                 while (!is_valid_move(ghost2_x+rand_x,ghost2_y+rand_y)){
...
//             if(is_valid_move(ghost2_x-1,ghost2_y)){
//             ghost2_x--
//             }
//             else{
//                 while (!is_valid_move(ghost2_x+rand_x,ghost2_y+rand_y)){
...
//         }
//     }
//     ctx.drawImage(ghost1Image,ghost2_x*30,ghost2_y*30,30,30);
// }

// function is_valid_move(x,y){
//     if (x>=20 || x<0 || y>=20 || x<0){
//         return false;
//     }
